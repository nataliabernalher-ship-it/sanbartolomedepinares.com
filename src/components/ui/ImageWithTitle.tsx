...
export function ImageWithTitle({
  ...
  const content = (
    <>
      ...
      <div className="relative z-10 flex w-[min(100%,480px)] flex-col items-center justify-center gap-4 rounded-xs bg-secondary-300 p-12 text-center text-neutral-600">
        <h3 className="font-montserrat w-full text-[length:var(--size-24)] leading-[var(--line-height-32)] font-normal tracking-[var(--letter-spacing-4)] uppercase">
          {title}
        </h3>
